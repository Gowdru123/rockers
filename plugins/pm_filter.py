...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('𝐓𝐇𝐄𝐀𝐓𝐄𝐑 𝐏𝐑𝐈𝐍𝐓 🎬', url=f'https://t.me/+9NYMiUfQ0RYyOTg1')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb:
        ...
        cap = f"\n<b>🔖ʰᵉʸ <b> {message.from_user.mention}\n\n𝑼𝒓 𝒓𝒆𝒒𝒖𝒆𝒔𝒕 𝒎𝒐𝒗𝒊𝒆  🖥 :- {search}\n𝑼𝒓 𝒓𝒆𝒒𝒖𝒆𝒔𝒕 𝒈𝒓𝒐𝒖𝒑 📡 :- 𝑹𝒐𝒄𝒌𝒆𝒓'𝒔 𝒎𝒐𝒗𝒊𝒆 𝒓𝒆𝒒𝒖𝒆𝒔𝒕 𝒈𝒓𝒐𝒖𝒑\n𝑼𝒓 𝒓𝒆𝒒𝒖𝒆𝒔𝒕 𝒕𝒚𝒑𝒆 ⌨  :- 𝒎𝒐𝒗𝒊𝒆 𝒘𝒆𝒃-𝒔𝒆𝒓𝒊𝒆𝒔\n\n<b>🧮 𝐀𝐥𝐥 𝐚𝐯𝐚𝐢𝐥𝐚𝐛𝐥𝐞 𝐪𝐮𝐚𝐥𝐢𝐭𝐲 𝐟𝐢𝐥𝐞 𝐮𝐩𝐥𝐨𝐚𝐝𝐞𝐝...\n\n<a href=https://t.me/ROCKERSBACKUP><b>📡 𝐑𝐎𝐂𝐊𝐄𝐑'𝐒 𝐎𝐅𝐅𝐈𝐂𝐈𝐀𝐋</b></a>\n\n\n" 
