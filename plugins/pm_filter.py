...
📌𝐣𝐨𝐢𝐧 𝐦𝐲 𝐛𝐚𝐜𝐤𝐮𝐩 𝐠𝐫𝐨𝐮𝐩 ಕನ್ನಡ 𝐭𝐚𝐦𝐢𝐥 𝐭𝐚𝐥𝐮𝐠𝐮 𝐡𝐢𝐧𝐝𝐢 𝐌𝐚𝐥𝐚𝐲𝐚𝐥𝐚𝐦 𝐦𝐨𝐯𝐢𝐞𝐬 𝐚𝐯𝐚𝐢𝐥𝐚𝐛𝐥𝐞 

<a href=https://t.me/+roiPDzCCnVdkZjI1><b>💎𝐑𝐎𝐂𝐊𝐄𝐑'𝐒 𝐌𝐎𝐕𝐈𝐄'𝐒 𝐑𝐄𝐐𝐔𝐄𝐒𝐓 𝐆𝐑𝐎𝐔𝐏💎</b></a>)
...
async def advantage_spell_chok(msg):
    ...
    pp = await msg.reply("💎𝐂𝐡𝐞𝐜𝐤 𝐮 𝐭𝐲𝐩𝐞𝐝 𝐜𝐨𝐫𝐫𝐞𝐜𝐭 𝐦𝐨𝐯𝐢𝐞 𝐧𝐚𝐦𝐞💎",
    reply_markup=InlineKeyboardMarkup(btn))                   
